...
# -*- coding: utf-8 -*-
"""
Простое тестирование Minecraft PE Server
...
def test_server_ping(host: str = 'localhost', port: int = 19132):
    """Простой тест ping сервера"""
    print(f"🔍 Тестирование ping сервера {host}:{port}")
...
def main():
    """Главная функция"""
    print("🎮 Простое тестирование Minecraft PE Server")
    print("=" * 50)
    ...
    # Тест 2: Ping сервера
    if not test_server_ping(host, port):
